...
export const Breadcrumbs = () => {
    ...
    const displayBreadcrumbs = pathSegments.length === 0
        ? [{ label: 'Лелека', href: '/', isHome: true }, { label: routeMap[''], href: '/', isHome: false }]
        : breadcrumbs;
